                    ...
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            text-white sm:text-5xl sm:leading-none">
                                SHARE THE WEALTH <br className="hidden md:block" />
                                Crowd Funding CK
                            </h2>
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    viewBox="0 0 12 12"
                                >
                                    <path d="M9.707,5.2931-5-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293,10.
                        ...
                        <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                            <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                <h3 className="mb-4 text-xl font-bold sm:text-center sm:mb-6 
                                sm:text-2xl">
                                    Campaign
                                </h3>
                                <form>

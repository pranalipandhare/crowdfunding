        ...
        <div className="relative">75
            ...
            <div className="relative bg-opacity-75 backgroundMain">
                ...
                >
                    ...
                    88 796 34 916 13C1036 -8 1156 1 1216 7.7L1276 13V162.5H1216C1156 162.5 1036
                    162.5 916 162.5C796 162.5 676 162.5 556 162.5C436 162.5 316 162.5 196 162.5
                    C76 162.5 -44 162.5 -104 162.5H-164V13Z"
                    />
                </svg>
                    ...
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                            ...
                            <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                                ...
                                gfiuefiefsj ;askpquwo nbcn hsidp weupwdjnc dnm,zcb gduiyp
                            </p>
                            <a
                                href="/"
                                aria-label=""
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    viewBox="0 0 12 12"
                                >
                                    <path d="M9.707,5.2931-5-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293,10.293a1,
                            ...
                            <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                                ...
                                <form>
                                    ...
                                    <div className="mb-1 sm:mb-2">
                                        <label
                                            htmlFor="email"
                                            className="inline-nlock mb-1 font-medium"
                                        >
                                            Deadline
                                        </label>
                                        <input

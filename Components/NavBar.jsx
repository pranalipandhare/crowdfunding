...
const NavBar = () => {
  ...
  return (
    <div class="backgroundMain">
      <div
        class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl 
            md:px-24 lg:px-8 "
      >
        <div class="relative flex items-center justify-between">
          <div class="flex items-center">
            ...
            >
              <Logo color="text-orange-500" />
              <span
                class="ml-2 text-xl font-bold tracking-wide text-orange-500
                            uppercase "
              >
                NGO Fund
              </span>
